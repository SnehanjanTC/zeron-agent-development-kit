...
def fetch_domain_intel(context: AgentContext, domain: str) -> dict:
    """
...
def generate_crml_scenario(
    ...
    # --- Build severity ---
    severity: dict = {"model": severity_model}
...
def validate_crml_scenario(context: AgentContext, yaml_content: str) -> dict:
    """
